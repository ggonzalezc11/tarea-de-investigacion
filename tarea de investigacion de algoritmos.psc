...
Algoritmo proyecto
	...
	Definir menuCadenasYArreglo Como Caracter
	...
	menuCadenasYArreglo[8] = "  9) ContarPalabras2"
	...
	menuCadenasYArreglo[17] = "  18) ContarCadena"
...
//Ejemplo: secuencia: 4,3,6,9,0  arreglo1=[4,3,6,9] arreglo2= [4,6]
...
//y final Ejemplo: numero1=2 numero2=10 salida= 6 7 8 9 10
...
//cantMenor18= 1, promedioMenor18=1
...
Funcion ContarCadena
    definir cadena1 como caracter 
	definir contadorComas, contadorPuntos, contadorDosPuntos, contadorPuntoComa Como Entero
	...
	Escribir "cantidad de puntos y coma: " , contadorPuntoComa
FinFuncion
...
Funcion ContarVocalesConsonantesDigitos
	...
	Definir n,ContadorConsonante,ContadorVocal,ContadorDigital Como Entero
	...
	Mientras contadorDigital <= n Hacer
		Segun Subcadena(frase,contadorDigital,contadorDigital) hacer
			"a" o "A":
		...
		FinSegun
		contadorDigital = contadorDigital + 1 
	FinMientras
	Escribir "Número de vocales:", contadorVocal
	Escribir "Número de consonantes:", contadorConsonante
	Escribir "Número de dígitos:", contadorDigital
